...
from config_55_w3d import cfg
from core.train_55_w3d import train_net
from core.test_55_w3d import test_net
from core.inference_55_w3d import infer_net
...
def get_args_from_command_line():
    ...
    parser.add_argument('--infer_root', help='Inference root dir', default='./demo_55/pts')
