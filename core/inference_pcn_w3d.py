...
from models.PCDreamer import PCDreamer_PCN_W3d
...
def infer_net(cfg, model=None, root='./demo_pcn/pts'):
    ...
    for file_name in os.listdir(root):
        ...
        with torch.no_grad():
            ...
            view_lst = []
            img_root = os.path.join(root.replace('pts', 'imgs'), 'w3d', file_name.split('.')[0])
            ...
            file_name = f'./infer_res/{file_str}/' + 'pred_pcn_w3d.xyz'
