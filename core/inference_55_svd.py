...
from models.PCDreamer import PCDreamer_55_Svd
from models.model_utils import fps_subsample
from utils.helpers import upsample_points, read_pfm
from utils.loss_utils import *


def infer_net(cfg, model=None, root='./demo_55/pts'):
    torch.backends.cudnn.benchmark = True

    # Setup networks and initialize networks
    if model is None:
        model = PCDreamer_55_Svd(cfg)
    ...
    for file_name in os.listdir(root):
        ...
        with torch.no_grad():
            ...
            file_name = f'./infer_res/{file_str}/' + 'pred_55_svd.xyz'
