...
__C.DATASETS.SHAPENET55.VIEW_PATH                  = './datasets/ShapeNet55/ShapeNet_55_imgs_svd/%s/%s/'

#
# Dataset
#
__C.DATASET                                      = edict()
__C.DATASET.TRAIN_DATASET                        = 'ShapeNetSVD55'
__C.DATASET.TEST_DATASET                         = 'ShapeNetSVD55'
...
__C.DIR                                          = edict()
__C.DIR.OUT_PATH                                 = 'PCDreamer_55_Svd'
__C.CONST.DEVICE                                 = '0,1,2,3'
__C.CONST.WEIGHTS                                = './checkpoints/ShapeNet55_svd.pth'
