...
__C.DATASETS.SHAPENET.VIEW_PATH                  = './datasets/PCN_imgs_svd/%s/%s/'

#
# Dataset
#
__C.DATASET                                      = edict()
__C.DATASET.TRAIN_DATASET                        = 'ShapeNetSVD'
__C.DATASET.TEST_DATASET                         = 'ShapeNetSVD'
__C.DATASET.VAL_DATASET                         = 'ShapeNetSVD'
...
__C.DIR                                          = edict()
__C.DIR.OUT_PATH                                 = 'PCDreamer_PCN_Svd'
__C.CONST.DEVICE                                 = '0,1,2,3'
__C.CONST.WEIGHTS                                = './checkpoints/PCN_svd.pth'
